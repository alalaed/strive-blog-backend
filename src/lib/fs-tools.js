// saveAuthorsPictures, saveBlogsPictures;
...
export const saveAuthorsPictures = (filename, contentAsABuffer) =>
  writeFile(join(authorsPublicFolderPath, filename), contentAsABuffer);
export const saveBlogsPictures = (filename, contentAsABuffer) =>
